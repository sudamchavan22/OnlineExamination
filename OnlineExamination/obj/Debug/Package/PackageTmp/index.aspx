...
<body style="background-image: url('images/max.jpg');background-size:cover;">
    <form id="form1" runat="server" >
        <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server"></asp:ToolkitScriptManager>
         <div class="menu">
             <asp:HiddenField runat="server" ID="hfExpDate" Value="08/31/2018" />
    ...
    <table align="center" style="font-size: large">
        <tr>
            <td>UserName</td><td><asp:TextBox ID="txtUserIdStud" runat="server" CssClass="formControl"  /></td>
                </tr>
        <tr><td class="auto-style1" colspan="2">
            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtUserIdStud" ErrorMessage="Enter UserName" ForeColor="Red" ValidationGroup="Register"></asp:RequiredFieldValidator>
            </td></tr>
        <tr><td>Password</td><td><asp:TextBox ID="txtPwdStud" runat="server" CssClass="formControl"/></td></tr>
        <tr><td class="auto-style5" colspan="2">
            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" Display="Dynamic" runat="server" ControlToValidate="txtPwdStud" ErrorMessage="Enter Password." ForeColor="Red" ValidationGroup="Register">
               <%--</asp:RequiredFieldValidator> <asp:RegularExpressionValidator ID="RegularExpressionValidator1" Display="Dynamic" ControlToValidate="txtPwd" ForeColor="Red" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ValidationGroup="Register" runat="server" ErrorMessage="invalied Email ID"></asp:RegularExpressionValidator>--%>
